...
const MenuSidebar: React.FC<MenuSidebarProps> = ({currentUser}) => {
    ...
    return ( 
        <div className="hidden sm:fixed sm:top-0 sm:bottom-0 sm:left-0 sm:z-20 sm:w-60 sm:px-1 sm:overflow-y-auto sm:bg-white sm:border-r-[1px] sm:pb-4 sm:flex sm:flex-col">
